...
public class ModuleCreatedEvent extends AbstractEvent<ModuleDetailsPayload> {
    private static final Priority PRIORITY = Priority.LOW;
    private static final String SOURCE_COMPONENT = "DT Management";
    private static final String EVENT_TYPE = "Modapto Module created";
    private static final String TOPIC = "modapto-module-creation";

    private ModuleCreatedEvent() {
    ...
    public static class Builder extends AbstractEvent.AbstractBuilder<ModuleDetailsPayload, ModuleCreatedEvent, Builder> {
        ...
        @Override
        protected ModuleCreatedEvent newBuildingInstance() {
            return new ModuleCreatedEvent();
        }
